...
import { updateScrollContext } from "../navigation/scrollSlice";
...
const Intro: FC<object> = () => {
    ...
    return <section className="bg-backdrop h-screen bg-cover grid place-items-center border-black border-[16px]">
