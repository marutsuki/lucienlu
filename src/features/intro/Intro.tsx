...
import { selectScrollContext, updateScrollContext } from "../navigation/scrollSlice";
...
const Intro: FC<object> = () => {
    ...
    return <section ref={sectionRef} className="select-none bg-backdrop h-screen bg-cover grid place-items-center border-black border-[16px]">
        ...
        <div className="mb-24">
            ...
            <div className="flex flex-row justify-center">
                <GenericSvg onClick={() => window.open("https://github.com/marutsuki", "_blank")} className="m-2 cursor-pointer" size={48} symbol="GitHub"/>
                <GenericSvg onClick={() => window.open("https://linkedin.com/in/lucienlu7789", "_blank")} className="m-2 cursor-pointer" size={48} symbol="LinkedIn"/>
            </div>
        </div>
    </section>
}
