...
export const repoConfig: RepoSectionConfig = {
    ...
    repos: [
        ...
        },
        {
            ...
            description:
                "A client-side NextJS application where you can view GitHub profiles in an aesthetic gaming theme.",
        ...
        },
        {
            ...
            description:
                "A React based implementation of the famous Conway's game of life in a modern look, right from your web browser!",
        ...
        },
        {
            title: "green-web",
            description:
                "A simple NextJS application providing a clean UI to access an open source API that measures the how sustainable a website is by measuring loading costs and times.",
            url: "https://green-web-beryl.vercel.app/",
        },
        {
            title: "OOP-Design-Patterns",
            description:
                "A Java dump of example object oriented designs, showcasing all 23 Gang of Four design patterns.",
