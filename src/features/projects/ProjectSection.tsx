                        ...
                        >
                            ...
                            <div>
                                <div className="flex justify-between">
                                    <h1 className="desktop:text-xl desktop:mb-4 text-lg group-hover:drop-shadow-[0px_0px_1px_rgba(255,255,255,1)] duration-300">
                                        {repo.title}
                                    </h1>
                                    <GenericSvg
                                        symbol="Link"
                                ...
                                <p className="text-left text-sm laptop:text-base desktop:text-lg font-code">
                                    {repo.description}
                                </p>
                            </div>
