import { FC, KeyboardEvent, ReactNode, useEffect, useState, HTMLProps, useRef } from "react";
...
const Computer: FC<ComputerProps> = ({ className, ...props }) => {
    ...
    return <div className={`${className} relative border-8 border-content m-auto w-[240px] h-[360px] laptop:w-[640px] laptop:h-[360px] laptop:py-2 laptop:px-4
        ...
        <div className="relative border-b w-full flex">
            ...
            <input ref={searchRef} className="border-none bg-transparent relative w-full focus:outline-none mr-2 laptop:mr-8 text-base" value={input} onChange={(e) => setInput(e.target.value)} onKeyDown={search}/>
        </div>
