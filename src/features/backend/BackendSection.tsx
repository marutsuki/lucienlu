...
const BackendSection: FC<object> = () => {
    ...
    return (
        <section
            ref={sectionRef}
            className="relative grid h-screen select-none grid-cols-1 grid-rows-2 place-items-center overflow-hidden text-xl laptop:grid-rows-1 desktop:grid-cols-2"
        >
