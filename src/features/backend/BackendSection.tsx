...
const BackendSection: FC<object> = () => {
    ...
    return (
        <section
            ref={sectionRef}
            className="select-none relative h-screen grid place-items-center text-xl grid-cols-1 grid-rows-2 desktop:grid-cols-2 laptop:grid-rows-1 overflow-hidden"
        >
